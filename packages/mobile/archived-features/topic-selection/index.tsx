/**
 * ARCHIVED FEATURE - TopicSelectScreen
 * 
 * This screen shows subtopics for a skill (e.g., Rust → Memory Management, Ownership & Borrowing)
 * 
 * Status: Archived for future implementation
 * Date Archived: Jan 2026
 * Location: archived-features/topic-selection/
 * 
 * Notes:
 * - Currently bypassed - app goes directly from Skills → Assessment
 * - References old 'topicSelection' and 'questions' routes (now 'assessment')
 * - Keep for future subtopics feature implementation
 */
...
export const TopicSelectScreen: React.FC = () => {
  // NOTE: 'topicSelection' route no longer active - archived
  ...
  const handleAssess = (topic: string) => {
    // NOTE: 'questions' route renamed to 'assessment' - update when re-implementing
